...
INSERT INTO t_num_game_type (id, sort, `type`, title, note, rightText, create_time, update_time, status) VALUES('kk1', '01', 'remove', '数字消消', '点击相同的数字进行消除', '', '2025-07-08 16:08:56', NULL, 'available');
INSERT INTO t_num_game_type (id, sort, `type`, title, note, rightText, create_time, update_time, status) VALUES('kk2', '02', 'remove', '颜色消消', '点击相同的颜色进行消除', '', '2025-07-08 16:08:56', NULL, 'available');
INSERT INTO t_num_game_type (id, sort, `type`, title, note, rightText, create_time, update_time, status) VALUES('kk3', '02', 'remove', '动物消消', '点击相同的动物进行消除', '', '2025-07-08 16:08:56', NULL, 'available');
INSERT INTO t_num_game_type (id, sort, `type`, title, note, rightText, create_time, update_time, status) VALUES('kk4', '02', 'remove', '动物和影子消消', '点击动物对应的影子进行消除', '', '2025-07-08 16:08:56', NULL, 'available');

INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg1', '01', 'remove', NULL, NULL, 1, NULL, 'general', 'v_item', '24', 600, 3, 9, '3 ✖️ 3', '1-9的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg2', '02', 'remove', NULL, NULL, 1, NULL, 'general', 'v_item', '20', 600, 4, 16, '4 ✖️ 4', '1-16的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg3', '03', 'remove', NULL, NULL, 1, NULL, 'general', 'v_item', '18', 3600, 5, 25, '5 ✖️ 5', '1-25的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg4', '04', 'remove', NULL, NULL, 1, NULL, 'general', 'v_item', '16', 3600, 6, 36, '6 ✖️ 6', '1-36的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg5', '05', 'remove', NULL, NULL, 1, NULL, 'general', 'v_item', '14', 3600, 7, 49, '7 ✖️ 7', '1-49的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg6', '06', 'remove', NULL, NULL, 1, NULL, 'general', 'v_item', '14', 3600, 7, 100, '10 ✖️ 10', '1-100的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('cc6', '06', 'simple', NULL, NULL, 1, NULL, 'general', 'v_item', '30rpx', 3600, 8, 64, '8 ✖️ 8', '1-64的数字', '', '2025-07-08 14:32:34', NULL, 'available');
INSERT INTO t_num_game_level (id, sort, `type`, levelHideTime, beginBlock, beginNum, levelSumNum, typeKey, itemCls, fontSize, gameTime, colNum, numSum, title, note, rightText, create_time, update_time, status) VALUES('gg7', '06', 'remove', NULL, NULL, 1, NULL, 'custom', 'v_item', '14', 3600, 7, 100, '自定义', '点击这个进行自定义设置', '', '2025-07-08 14:32:34', NULL, 'available');
