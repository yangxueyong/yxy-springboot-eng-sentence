  ...
  switch (currentGameType.value.id) {
    ...
    case 'a2': // 颜色消消乐
      ...
      for (let i = 0; i < colorCount; i++) {
        pairs.push(selectedColors[i], selectedColors[i])
      }
      break;
    ...
    case 'a3': // 动物消消乐
      ...
      for (let i = 0; i < animalCount; i++) {
        pairs.push(selectedAnimals[i].imgSrc, selectedAnimals[i].imgSrc)
      }
      break;
    ...
    case 'a4': // 动物和影子消消乐
      ...
      // 确保有足够的配对
      for (let i = 0; i < shadowAnimalCount; i++) {
        pairs.push(selectedShadowAnimals[i].imgSrc, selectedShadowAnimals[i].shadowSrc)
      }
      break;
  }
