 ...
 */
@ApiModel(value="com.example.yxy.entity.eng.EngSentenceWordDetail",description="句型中的单词信息")
@Data()
public class EngSentenceWordDetail {
    /**
     * 主键
     */
     ...
     * 详情id
     */
    @ApiModelProperty(value="详情id",name="detailId")
